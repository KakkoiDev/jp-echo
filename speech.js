export class ShadowLoop{
  ...
  togglePause(){
    ...
    if(this.paused){this.play(this.text,{voice:this.voice,rate:this.rate});return false}
    this.paused=true;
